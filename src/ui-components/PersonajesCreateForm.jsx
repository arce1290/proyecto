...
import { createPersonajes } from "../graphql/mutations";
const client = generateClient();
export default function PersonajesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPersonaje(initialValues.Personaje);
    setAnime(initialValues.Anime);
    setRaza(initialValues.Raza);
    setEdad(initialValues.Edad);
    setPeso(initialValues.Peso);
    setAltura(initialValues.Altura);
    setPoder(initialValues.poder);
    setAtaque(initialValues.Ataque);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPersonajes.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PersonajesCreateForm")}
      {...rest}
    >
      <TextField
        label="Personaje"
